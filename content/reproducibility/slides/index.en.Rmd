...
Però sus entradas van a **envejecer**, su sitio no tiene que sera una documentación siempre actualizada.
{{% /fragment %}}
...
{{% fragment %}}
Tal vez se pueden utilizar los .md, con algunas modificaciones del YAML.

Cuando movi mi blog de Jekyll a Hugo, para entradas viejas, utilizé los .md, no los .Rmd.
{{% /fragment %}}
...
`r hugodown::embed_tweet("1311959289796452352")`
